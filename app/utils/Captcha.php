...
$captchaFont = "sewer.ttf";
$captchaFontSize = rand(30, 40); // Tamaño de la fuente
$caracter = 0;
while ($caracter < $totalCharacteres) {
    $captcha .= substr($possiblesLetras, rand(1, strlen($possiblesLetras)), 1); // Se extrae 1 letra de $possiblesLetras de la posición aleatoria según el tamaño de la variable.
    $caracter++;
}
